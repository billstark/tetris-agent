...
public class GAPlayer {
     ...
     * allow particles to be pulled to correct direction quickly at the beginning.
     * And since we are allowing particles to run until die at the beginning,
     ...
     * 
     * @return a double number that represents the fitness of the particle
     */
